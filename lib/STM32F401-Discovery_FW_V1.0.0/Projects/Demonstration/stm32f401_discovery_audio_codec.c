...
--------------------------
   - This driver supports STM32F4xx devices on STM32F401-Discovery Kit.

   - Configure the options in file stm32f401_discovery_audio_codec.h in the section CONFIGURATION.
   ...
   - For each mode, you may need to implement the relative callback functions into your code.
      ...
      the stm32f401_discovery_audio_codec.h file. (refer to the example for more details on the callbacks implementations)
   ...
   - The driver API and the callback functions are at the end of the stm32f401_discovery_audio_codec.h file.
 

 Driver architecture:
 --------------------
 This driver is composed of three main layers:
   o High Audio Layer: consists of the function API exported in the stm32f401_discovery_audio_codec.h file
   ...
   o Codec Control layer: consists of the functions API controlling the audio codec (CS43L22) and 
     included as local functions in file stm32f401_discovery_audio_codec.c (Codec_Init(), Codec_Play() ...)
   o Media Access Layer (MAL): which consists of functions allowing to access the media containing/
     providing the audio file/stream. These functions are also included as local functions into
     the stm32f401_discovery_audio_codec.c file (Audio_MAL_Init(), Audio_MAL_Play() ...)
...
/** @addtogroup STM32F401_DISCOVERY_AUDIO_CODEC
  * @brief       This file includes the low layer driver for CS43L22 Audio Codec
  *              available on STM32F401-Discovery Kit.
  * @{
  */ 

/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Defines
  * @{
  */ 
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Variables
  * @{
  */
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Private_Functions
  * @{
  */ 
...
#error "AUDIO_MAL_MODE_NORMAL or AUDIO_MAL_MODE_CIRCULAR should be selected !!"
    ...
    /* Enable the selected DMA interrupts (selected in "stm32f401_discovery_eval_audio_codec.h" defines) */
#ifdef AUDIO_MAL_DMA_IT_TC_EN
